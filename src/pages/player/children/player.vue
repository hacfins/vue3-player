	...
	<div class="playe-wrap">
		<div class="player-wrap-cnt">
			<div class="player-wrap-right">
				<detail-video
					v-show="liveInfo.f_type == 1"
					:playSection="playSection"
					ref="detail_video">
				</detail-video>
				<detail-pic
					v-show="liveInfo.f_type == 2"
					:playSection="playSection"
					ref="detail_pic"
					:showThumb="true"
					:picList="picList">
				...
				<detail-doc
					v-show="(liveInfo.f_type == 3 || liveInfo.f_type== 31 || liveInfo.f_type == 32 || liveInfo.f_type == 33)"
					:playSection="playSection"
					ref="detail_doc">
				</detail-doc>
				<detail-ppt
					v-show="liveInfo.f_type == 34"
					:playSection="playSection"
					ref="detail_ppt">
				</detail-ppt>
				<detail-audio
					v-show="liveInfo.f_type == 4"
					:playSection="playSection"
					:audioList="audioList"
					ref="detail_audio">
				</detail-audio>
			...
			<div class="player-wrap-left">
				<div class="lesson-list-wrap">
					<course-catalog ref="catalog"  @catReqSuccess="catReqSuccess" @change="changeLesson"></course-catalog>
				</div>
			</div>
		</div>
	</div>
